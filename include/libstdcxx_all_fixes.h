...
#ifndef __INCLUDED_LIBSTDCXXFIX_LIBSTDCXX_ALL_FIXES_H__
#define __INCLUDED_LIBSTDCXXFIX_LIBSTDCXX_ALL_FIXES_H__

#include <libstdcxx_memory_fix.h>
#include <libstdcxx_iomanip_fix.h>

#endif // __INCLUDED_LIBSTDCXXFIX_LIBSTDCXX_ALL_FIXES_H__
